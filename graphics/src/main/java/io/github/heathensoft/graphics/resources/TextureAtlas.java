...
import io.github.heathensoft.graphics.TextureRegion;
import io.github.heathensoft.graphics.texture.ITex2D;
 ...
 * NOTE:
 *
 * When using texture arrays, i.e. one atlas-texure for each: diffuse, normals etc. it is assumed that
 * the atlas-regions match excactly for each texture. (the layouts should match)
 *
...
public class TextureAtlas<T extends ITex2D> {
    ...
    public TextureAtlas(T texture, List<String> layout) throws Exception {
