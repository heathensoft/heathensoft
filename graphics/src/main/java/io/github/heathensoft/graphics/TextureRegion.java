...
public class TextureRegion {
    ...
    private ITex2D texture;
    
    public TextureRegion(ITex2D texture) {
        this(texture,0,0, texture.width(), texture.height());
    }
    
    public TextureRegion(ITex2D texture, int x, int y, int w, int h) {
        this.texture = texture;
        setRegion(x, y, w, h);
        subDivide(1,1);
    }
    
    public TextureRegion(ITex2D texture, float u, float v, float u2, float v2) {
        this.texture = texture;
        setRegion(u, v, u2, v2);
        subDivide(1,1);
    }
    ...
    public void setTexture(ITex2D texture) {
        this.texture = texture;
    }
    
    public ITex2D texture() {
        return texture;
    }
